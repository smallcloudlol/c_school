...
namespace WinFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void listBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedIndex == 2) radioButton7.Checked = true;
        }

        private void comboBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex == 0) radioButton4.Checked = true;
            if (comboBox1.SelectedIndex == 1) radioButton3.Checked = true;
            if (comboBox1.SelectedIndex == 2) radioButton8.Checked = true;
        }
        private void comboBox2_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (comboBox2.SelectedIndex == 0) radioButton6.Checked = true;
            if (comboBox2.SelectedIndex == 1) radioButton5.Checked = true;
            if (comboBox2.SelectedIndex == 2) radioButton9.Checked = true;
        }
